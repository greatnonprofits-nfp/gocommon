...
func NewPrivateS3(client S3Client, bucket string, workersPerBatch int, publicBucketUrl string) Storage {
	return &privateS3Storage{
		client: client, bucket: bucket, workersPerBatch: workersPerBatch, publicBucketUrl: publicBucketUrl,
	}
}
...
func (s *privateS3Storage) Test(ctx context.Context) error {
...
func (s *privateS3Storage) Get(ctx context.Context, path string) (string, []byte, error) {
...
func (s *privateS3Storage) Put(ctx context.Context, path string, contentType string, contents []byte) (string, error) {
...
func (s *privateS3Storage) batchWorker(ctx context.Context, uploads chan *Upload, errors chan error, stop chan bool, wg *sync.WaitGroup) {
	wg.Add(1)
	defer wg.Done()
...
func (s *privateS3Storage) BatchPut(ctx context.Context, us []*Upload) error {
